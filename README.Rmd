...
```{r search9, include = TRUE , echo=TRUE}
...
```  
  ...
  #        setView(lng = 41.408492 , lat = 2.226725 , zoom = 15) # %>%
          ...
          #addMarkers(lng = as.double(diplodus_forum 
          #longitude), lat = as.double(diplodus_forum$latitude) ,group = "Markers")
...
```{r search8, include = TRUE , echo=TRUE, imag.caption= 'User Image'}
